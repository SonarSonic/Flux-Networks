...
public class FluxCrafting extends FluxNetworks {
	...
	public static void addRecipes() {
		...
		SonarCrafting.addShaped(new ItemStack(fluxBlock, 1), new Object[] { "ACA", "CAC", "ACA", 'A', flux, 'C', fluxCore });
		SonarCrafting.addShaped(new ItemStack(fluxCore, 4), new Object[] { "GCG", "CAC", "GCG", 'C', Blocks.OBSIDIAN, 'G', flux, 'A', Items.ENDER_EYE });
		SonarCrafting.addShaped(new ItemStack(fluxController, 1), new Object[] { "BCB", "R R", "BBB", 'C', fluxCore, 'B', fluxBlock, 'R', flux });
		SonarCrafting.addShaped(new ItemStack(fluxPlug, 1), new Object[] { " C ", "CBC", " C ", 'C', fluxCore, 'B', fluxBlock });
		SonarCrafting.addShaped(new ItemStack(fluxPoint, 1), new Object[] { " C ", "CBC", " C ", 'C', fluxCore, 'B', Blocks.REDSTONE_BLOCK });
