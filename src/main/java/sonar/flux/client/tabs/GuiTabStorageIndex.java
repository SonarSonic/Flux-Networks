...
public class GuiTabStorageIndex extends GuiTabConnectionIndex<TileStorage> {
	...
	public void drawGuiContainerForegroundLayer(int x, int y) {
		...
		FontHelper.text("Network Buffer: " + (common.getEnergyAvailable() != 0 ? +(flux.storage.getEnergyStored() * 100 / common.getEnergyAvailable()) + " %" : ""), 14, 120 + 4, colour);
	}
