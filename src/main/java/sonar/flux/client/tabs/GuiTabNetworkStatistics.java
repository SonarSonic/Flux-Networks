...
public class GuiTabNetworkStatistics extends AbstractGuiTab {
	...
	public void drawGuiContainerForegroundLayer(int x, int y) {
		...
		if (common.isFakeNetwork()) {
			...
			FontHelper.text(TextFormatting.DARK_GRAY + GUI.CONTROLLERS.toString() + TextFormatting.DARK_GRAY + ": " + TextFormatting.RESET + stats.flux_controller_count, 12, 26 + 12 * 3, rgb);

			FontHelper.text(TextFormatting.DARK_GRAY + GUI.TOTAL_INPUT.toString() + TextFormatting.DARK_GRAY + ": " + TextFormatting.RESET + FontHelper.formatOutput(common.getDefaultEnergyType(), stats.total_energy_added), 12, 26 + 12 * 4, rgb);
			FontHelper.text(TextFormatting.DARK_GRAY + GUI.TOTAL_OUTPUT.toString() + TextFormatting.DARK_GRAY + ": " + TextFormatting.RESET + FontHelper.formatOutput(common.getDefaultEnergyType(), stats.total_energy_removed), 12, 26 + 12 * 5, rgb);
