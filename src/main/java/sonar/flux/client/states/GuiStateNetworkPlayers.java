...
import sonar.flux.client.GuiFluxBase.SelectButtons;
			...
			if (!players.isEmpty()) {
				...
				for (int i = start; i < finish; i++) {
					...
					if (players.get(i) != null) {
						...
						flux.drawRect(xPos, yPos, xPos + 154, yPos + 12, (access.canDelete() || isOwner) ? Color.lightGray.getRGB() : access.canEdit() ? flux.colours[7].getRGB() : !access.canConnect() ? flux.colours[4].getRGB() : flux.lightBlue);
