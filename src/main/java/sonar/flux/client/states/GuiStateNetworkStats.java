...
public class GuiStateNetworkStats extends GuiState {
    ...
    public void draw(GuiFlux flux, int x, int y) {
        if (flux.disabledState) {
            ...
            NetworkStatistics stats = flux.common.getStatistics();
            ...
            FontHelper.text(TextFormatting.DARK_GRAY + GUI.POINTS.toString() + TextFormatting.DARK_GRAY + ": " + TextFormatting.RESET + stats.getConnectionCount(ConnectionType.POINT), 12, 26 + 12, rgb);
